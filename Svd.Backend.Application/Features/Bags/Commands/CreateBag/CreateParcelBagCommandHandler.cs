...
public class CreateParcelBagCommandHandler :
    IRequestHandler<CreateParcelBagCommand, BaseResponse<BagViewModel>>
{
    ...
    public CreateParcelBagCommandHandler(
        IMapper mapper,
    ...
    public async Task<BaseResponse<BagViewModel>> Handle(
        CreateParcelBagCommand request,
        CancellationToken cancellationToken)
    {
        var validator = new CreateParcelBagCommandValidator(
            _bagRepository,
            _shipmentRepository,
            _shipmentSettings);
